...
export interface AudioEngine {
  ...
  startPlayback: (melody: PlayedNote[], chords: PlayedChord[], converter: NoteConverter, skipCadence?: boolean, slotStates?: { melody: Map<number, boolean>, chord: Map<number, boolean> }) => Promise<void>;
  pausePlayback: () => void;
  stopPlayback: () => void;
  ...
  playBackingChordsOnly: (chords: PlayedChord[], converter: NoteConverter, slotStates?: Map<number, boolean>) => void;
  playMelodyOnly: (melody: PlayedNote[], converter: NoteConverter, slotStates?: Map<number, boolean>) => void;
