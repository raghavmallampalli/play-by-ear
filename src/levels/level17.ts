...
export class Level17 extends BaseLevel {
...
const levelInstance = new Level17();
export const buildLevel17 = () => levelInstance.build();
export const LEVEL17_ANSWER_CHOICES = levelInstance.answerChoices;
