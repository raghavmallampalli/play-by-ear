...
const levelInstance = new Level11();
export const buildLevel11 = () => levelInstance.build();
export const LEVEL11_ANSWER_CHOICES = levelInstance.answerChoices;
