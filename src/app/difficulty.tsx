...
import {
  ...
  IconAlert,
  IconWrench,
} from '@/components/icons/NativeIcons';
...
const LEVEL_STAGES = [
  {
    ...
    levels: [
      {
        id: 1,
        name: 'Level 1: Do Re Mi Fa (Degrees 1–4)',
        detail: 'Lower tetrachord — C D E F in C major',
      },
      {
        id: 2,
        name: 'Level 2: Sol La Ti Do (Degrees 5–8)',
        detail: 'Upper tetrachord — G A B C, including the leading tone (7th)',
      },
      {
        id: 3,
        name: 'Level 3: Happy Birthday Melody',
        detail: 'Full melody dictation — identify each note by scale degree',
      },
    ],
  },
  {
    ...
    levels: [
      {
        id: 4,
        name: 'Level 4: I · IV · V Chords',
        detail: 'Pure chord recognition — no melody, root position triads',
      },
      {
        id: 5,
        name: 'Level 5: Chords With Melody',
        detail: 'Chord recognition with a diatonic melody note on top',
      },
      {
        id: 6,
        name: 'Level 6: Happy Birthday + Chords',
        detail: 'Full harmonization — identify each chord while the melody plays',
      },
    ],
  },
  {
    ...
    levels: [
      {
        id: 7,
        name: 'Level 7: Minor vs Major Triads',
        detail: 'Pure chord recognition — distinguishing major and minor',
      },
      {
        id: 8,
        name: 'Level 8: Chords With Melody',
        detail: 'Chord recognition with a diatonic melody note on top',
      },
      {
        id: 9,
        name: 'Level 9: Real Song Recognition',
        detail: 'Identify chords from a real song excerpt',
      },
    ],
  },
  {
    ...
    levels: [
      {
        id: 10,
        name: 'Level 10: Diminished & Augmented Triads',
        detail: 'Pure chord recognition — dim and aug triads',
      },
      {
        id: 11,
        name: 'Level 11: Chords With Melody',
        detail: 'Chord recognition with a diatonic melody note on top',
      },
      {
        id: 12,
        name: 'Level 12: Real Song Recognition',
        detail: 'Identify chords from a real song excerpt',
      },
    ],
  },
  {
    ...
    levels: [
      {
        id: 13,
        name: 'Level 13: Suspended Chords',
        detail: 'Pure chord recognition — sus2 and sus4',
      },
      {
        id: 14,
        name: 'Level 14: Chords With Melody',
        detail: 'Chord recognition with a diatonic melody note on top',
      },
      {
        id: 15,
        name: 'Level 15: Real Song Recognition',
        detail: 'Identify chords from a real song excerpt',
      },
    ],
  },
  {
    ...
    levels: [
      ...
      {
        id: 17,
        name: 'Level 17: Chords With Melody',
        detail: 'Chord recognition with a diatonic melody note on top',
      },
      {
        id: 18,
        name: 'Level 18: Real Song Recognition',
        detail: 'Identify chords from a real song excerpt',
      },
    ],
  },
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        >
          <Text style={styles.introText}>
            Progress through the progressive training stages below. To begin, let&apos;s play the
            first levels!
          </Text>
          ...
          <View style={[styles.grid, isLandscape && styles.gridLandscape]}>
            {LEVEL_STAGES.map((stage, stageIdx) => (
              <View
                key={stageIdx}
                style={[styles.stageCard, isLandscape && styles.stageCardLandscape]}
              >
                    ...
                    return (
                      ...
                      >
                        ...
                        <View style={styles.rightContainer}>
                          {bestScore > 0 && !isTbd && (
                            <Text
                              style={[styles.bestScoreText, !isInteractive && styles.textDisabled]}
                            >
                              Best: {bestScore}%
                            </Text>
                          )}
                          <View
                            style={isInteractive ? styles.activeIndicator : styles.lockedIndicator}
                          >
                            {isInteractive ? (
          ...
          <View style={styles.modalCard}>
            ...
            <View style={styles.modalContent}>
              ...
              <Text style={styles.modalDesc}>
                Level {levelToUnlock} is currently locked. Would you like to bypass the lock and
                play it?
              </Text>
            </View>
